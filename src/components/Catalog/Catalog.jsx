    ...
    return (
        <div>
            ...
            <div className='product-list'>
                ...
                <ProductCard id={4} title={"Четвертый товар"} price={69999} image={pathProduct4}/>
                <ProductCard id={5} title={"Пятый товар"} price={58800} image={pathProduct5}/>
                <ProductCard id={6} title={"Шестой товар"} price={10000000} image={pathProduct6}/>
            </div>
